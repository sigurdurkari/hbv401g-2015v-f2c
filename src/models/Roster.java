...
public class Roster {
	...
	public void setPlayers(List<MockPlayer> players) {
		...
		this.onField.addAll(players.size()>11 ? players.subList(0, 11) : players);
		this.subs.addAll(players.size()>11 ? players.subList(11, players.size()) : new ArrayList<MockPlayer>());
		sort();
	}
